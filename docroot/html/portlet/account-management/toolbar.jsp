...
<div class="lfr-portlet-toolbar">
	...
	<c:if test="<%= PermissionsChecker.hasGroupPermission(
		...
		<span class="lfr-toolbar-button add-user-button <%= toolbarItem.equals("add") ? "current" : StringPool.BLANK %>">
			<a href="<%= addAccountURL %>"><liferay-ui:message key="add-account" /></a>
		</span>	
	</c:if>
