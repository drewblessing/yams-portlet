...
/**
 * The interface for the action log local service.
 *
 * <p>
...
public interface ActionLogLocalService extends PersistedModelLocalService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ActionLogLocalServiceUtil} to access the action log local service. Add custom service methods to {@link org.gnenc.yams.service.impl.ActionLogLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
