...
public abstract class PermissionsDefinedLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PermissionsDefinedLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public PermissionsDefined deletePermissionsDefined(String permissionKey)
		throws PortalException, SystemException {
		return permissionsDefinedPersistence.remove(permissionKey);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public PermissionsDefined deletePermissionsDefined(
		PermissionsDefined permissionsDefined) throws SystemException {
		return permissionsDefinedPersistence.remove(permissionsDefined);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(PermissionsDefined.class,
	...
	public PermissionsDefined updatePermissionsDefined(
		...
		return permissionsDefinedPersistence.update(permissionsDefined, merge);
	}
	...
	private PermissionsDefinedLocalServiceClpInvoker _clpInvoker = new PermissionsDefinedLocalServiceClpInvoker();
}